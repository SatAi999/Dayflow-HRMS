...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-tr from-blue-600 via-indigo-700 to-purple-800 px-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl bg-white/95 backdrop-blur-md p-8 shadow-2xl border border-white/20 animate-fade-in">
