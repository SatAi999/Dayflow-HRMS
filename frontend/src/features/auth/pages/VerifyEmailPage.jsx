    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-md border border-gray-100">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Please verify your corporate email to activate your account.</p>
        </div>
        <div className="mt-8 space-y-4">
          ...
          <div className="text-center text-sm">
            <Link to="/login" className="text-primary-600 font-medium hover:underline">Proceed to Login</Link>
          </div>
        </div>
      </div>
    </div>
